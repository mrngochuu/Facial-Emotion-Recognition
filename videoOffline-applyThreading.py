...
ap.add_argument("-q", "--queue", type=int, default=128, help="queue to put frames")
...
fvs = FileVideoStreamCustom(args["video"], args['queue'], args['fps']).start()
time.sleep(1.0)
# start the FPS timer
fps = FPS().start()
